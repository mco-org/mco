...
This release changes MCO from a findings/decision pipeline into a raw-answer invocation runtime. Legacy findings-driven design documents remain available for context but are superseded by the [invocation runtime v1 contract](../contracts/invocation-runtime-v1.md); this note is the migration guide for callers adopting the new public surface.
