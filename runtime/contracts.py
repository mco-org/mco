...
ProviderId = Literal["claude", "codex", "gemini", "opencode", "qwen", "hermes", "pi", "copilot"]
...
PROVIDER_IDS: Sequence[ProviderId] = ("claude", "codex", "gemini", "opencode", "qwen", "hermes", "pi", "copilot")
