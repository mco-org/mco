...
class TestColdStartWeightMixing:
    def test_pure_cold_start_uses_stack_and_global(self) -> None:
        ...
        assert result["claude"] == pytest.approx(0.71)
        assert result["gemini"] == pytest.approx(0.57)
    ...
    def test_fully_mature_uses_repo_only(self) -> None:
        ...
        assert result["claude"] == pytest.approx(0.9)
        assert result["gemini"] == pytest.approx(0.7)
    ...
    def test_partial_maturity_blends(self) -> None:
        ...
        assert result["claude"] == pytest.approx(0.77)
    ...
    def test_missing_agent_in_some_sources(self) -> None:
        ...
        assert result["cursor"] == pytest.approx(0.85)
