...
def build_render_context(summary: Dict[str, Any], summary_json_path: str) -> Dict[str, str]:
    ...
    return {
        ...
        "serial_success_count": str(_value(serial, "successful_count", 0)),
        "serial_failed_count": str(_value(serial, "failed_count", 0)),
        "serial_success_ratio": _ratio_text(
            _value(serial, "successful_count", 0),
            _value(serial, "invocations_total", 0),
            _value(serial, "success_rate", None),
        ),
        ...
        "parallel_success_count": str(_value(parallel, "successful_count", 0)),
        "parallel_failed_count": str(_value(parallel, "failed_count", 0)),
        "parallel_success_ratio": _ratio_text(
            _value(parallel, "successful_count", 0),
            _value(parallel, "invocations_total", 0),
            _value(parallel, "success_rate", None),
        ),
